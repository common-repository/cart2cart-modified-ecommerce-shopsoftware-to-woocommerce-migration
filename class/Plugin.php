...
class Plugin
{
  const PLUGINS_TITLE = 'Cart2cart: modified eCommerce Shopsoftware to Woocommerce Plugin';
  ...
  const URL_LIMIT = 'from-modifiedecommerceshopsoftware-to-woocommerce';
  const SOURCE_CART_ID = 'Modified';
